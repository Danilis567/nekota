    ...
    return (
        <div>
            ...
            <ContentSection id="madde-4" title="Temel Gelirler">
                <p><strong>4.1. Reklam Gelirleri:</strong> Sanatçı'nın İçeriklerinin Nekota platformunda gösterimi sırasında elde edilen reklam gelirlerinin (Google Ads, vb.) net tutarının %25'i Sanatçı'ya aittir. Performans Bonusu: Sanatçı'nın Platform'daki ikinci yılının başlangıcından itibaren, bir önceki 12 aylık dönemde İçerikleri toplamda 50.000 reklam gösterimini aşmış ise, reklam geliri payı oranı %40'a yükseltilir.</p>
                <p><strong>4.2. Abonelik Yönlendirme Geliri:</strong> Platform tarafından Sanatçı'ya özel olarak sağlanan yönlendirme linki (affiliate link) aracılığıyla Nekota platformuna yeni bir ücretli abone kazandırılması durumunda, ilgili abonenin ödediği ilk abonelik ücretinin net tutarının %25'i Sanatçı'ya aittir.</p>
                <p><strong>4.3. Bağış Gelirleri:</strong> Kullanıcıların doğrudan Sanatçı'ya yaptığı bağışların, ödeme işlemcisi komisyonları gibi zorunlu kesintiler yapıldıktan sonraki net tutarının %95'i Sanatçı'ya aittir. Tam Bağış Hakkı: Sanatçı, Platform üzerinde 10.000 aktif takipçiye ulaşması ve İçeriklerinin aylık 2.500 reklam gösterimini geçmesi durumunda, bağışlardan elde edilen gelirin (zorunlu kesintiler hariç) %100'ünü alma hakkı kazanır.</p>
            </ContentSection>
            ...
            <ContentSection id="madde-5" title="YouTube Promosyonu">
                ...
                <ul className="list-disc pl-6 space-y-4">
                    ...
                    <li><strong>5.2. Geliştirilmiş Gelir Modeli:</strong> Bu seçeneği kabul eden Sanatçı için Madde 4'teki gelir oranları şu şekilde güncellenir: Platform Reklam Geliri Payı (%40), Abonelik Yönlendirme Geliri Payı (%75), Bağış Geliri Payı (şartsız %100).</li>
                    <li><strong>5.3. Ana Kanal'dan Elde Edilen Gelir:</strong> Sanatçı'nın İçeriğinin Ana Kanal'da yayınlanan videosundan elde edilen YouTube reklam gelirlerinin net tutarının %40'ı Sanatçı'ya aittir.</li>
            ...
            <ContentSection id="madde-y" title="Katmanlı Abonelik Modeli">
                ...
                <p><strong>Y.3. Gelir Paylaşımı:</strong> Abonelerden elde edilen aylık brüt gelirin %85'i Sanatçı'ya aittir. Geriye kalan %15'lik pay, Platform'a hizmet bedeli olarak ödenir.</p>
            ...
            <ContentSection id="madde-z" title="Kitle Fonlaması Modeli">
                ...
                <p><strong>Z.3. Gelir Paylaşımı:</strong> Başarıyla tamamlanan her Proje için toplanan toplam brüt fonun %90'ı Sanatçı'ya aittir. Platform, %10 oranında hizmet bedeli alır.</p>
